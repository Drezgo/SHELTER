        ...
        page.add(
            ...
            ft.Column(
                [
                    ...
                    ft.Text("Визначення зниження дози проникаючої радіації у забудові", size=16, weight="bold"),
                    dropdown_left_1,
                    ft.Divider(),
                    ft.Text("Визначення послаблення радіації огороджувальними конструкціями будівель", size=16, weight="bold"),
                    dropdown_left_2,
                    ft.Row(
                        [
                            ft.ElevatedButton(
